...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(
         ...
         RALT_T(KC_SPACE), OSM(MOD_LSFT),           KC_LCTL, DF(1)
    ),
	[1] = LAYOUT_split_3x5_2(
            ...
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PDOT,        KC_NO, KC_NO, KC_NO, KC_NO, DF(2),
                                    DF(0), LSFT_T(KC_1),        LCTL_T(KC_0), LALT_T(KC_LGUI)
    ),
	[2] = LAYOUT_split_3x5_2(
           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
           KC_TRNS, KC_EQL, KC_QUOT, KC_DQUO, KC_MINUS,         KC_BSLS, KC_LBRC, KC_RBRC, KC_PIPE, KC_TRNS,
                KC_TILD, KC_GRV, KC_NO, KC_NO, KC_EXLM,         KC_PLUS, KC_LPRN, KC_RPRN, KC_LCTL, DF(3),
                                        DF(0), KC_LSFT,         KC_RALT, DF(1)
    ),
	[3] = LAYOUT_split_3x5_2(
                KC_TRNS, KC_NO, KC_UP, KC_TRNS, KC_VOLU,         KC_TRNS, KC_BTN1, KC_WH_U, KC_BTN2, KC_TRNS,
             KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT, KC_VOLD,         KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,
            QK_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS, KC_WH_L, KC_WH_D, KC_WH_R, DF(4),
                                         DF(0), KC_TRNS,         OSM(MOD_LCTL|MOD_LGUI), DF(3)
    ),
	[4] = LAYOUT_split_3x5_2(
              ...
              KC_LCTL, KC_X, KC_C, KC_V, KC_B,        KC_NO, KC_NO, KC_NO, KC_NO, US_IQUE,
                              KC_SPACE, DF(0),        KC_TRNS, KC_NO
    ),
